...
//              }
        ...
        private void handleResponse(Socket socket) {
            try {
                ...
                //Log.(CloudUtil.TAG, pre.toString());
                //Log.(CloudUtil.TAG, "Params: "+parms.toString());
                //Log.(CloudUtil.TAG, "Header: "+header.toString());
            ...
            try
            {
                ...
                if ( data != null )
                {
                    ...
                    while ((read = data.read(buff))>0){
                        //if(SolidExplorer.LOG)//Log.(CloudUtil.TAG, "Read: "+ read +", pending: "+ data.availableExact());
