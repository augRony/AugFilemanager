...
import com.augustro.filemanager.filesystem.Operations;
...
import com.augustro.filemanager.ui.dialogs.SmbSearchDialog;
...
public class MainActivityHelper {
    ...
    public void add(int pos) {
        final MainFragment ma = (MainFragment) mainActivity.getFragmentAtFrame();//) ((TabFragment) mainActivity.getSupportFragmentManager().findFragmentById(R.id.content_frame)).getCurrentTabFragment();
...
//        if (tabFragment == null) return;
        if (mainActivity != null) {
            final MainFragment ma = (MainFragment) mainActivity.getFragmentAtFrame();
        ...
        /*SearchTask task = new SearchTask(ma.searchHelper, ma, query);
            ...
            //ma.searchTask = task;
            SEARCH_TEXT = query;
            mainActivity.mainFragment = (MainFragment) mainActivity.getFragmentAtFrame();
