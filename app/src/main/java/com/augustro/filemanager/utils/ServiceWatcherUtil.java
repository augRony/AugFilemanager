...
import com.augustro.filemanager.asynchronous.services.AbstractProgressiveService;
import com.augustro.filemanager.ui.notifications.NotificationConstants;

import java.util.concurrent.ConcurrentLinkedQueue;

import static com.augustro.filemanager.utils.ServiceWatcherUtil.ServiceWatcherInteractionInterface.STATE_HALTED;
import static com.augustro.filemanager.utils.ServiceWatcherUtil.ServiceWatcherInteractionInterface.STATE_RESUMED;
import static com.augustro.filemanager.utils.ServiceWatcherUtil.ServiceWatcherInteractionInterface.STATE_UNSET;
    ...
    private static synchronized void postWaiting(final Context context) {
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                //Log.(getClass().getSimpleName(), "Processes in progress, delay the check");
