package com.augustro.filemanager.ui.views.appbar;
...
public class BottomBar implements View.OnTouchListener, View.OnClickListener{
    ...
    public AppCompatImageView toGridButton;
    public AppCompatImageView toListButton;
    ...
    public BottomBar(AppBar appbar, MainActivity a) {
        ...
        toGridButton = a.findViewById(R.id.toGridButton);
        toListButton = a.findViewById(R.id.toListButton);
        @ColorInt int accent = a.getAccent();
        toGridButton.setColorFilter(accent);
        toListButton.setColorFilter(accent);
...
//        });
    ...
    public void setClickListener() {// TODO: 15/8/2017 this is a horrible hack, if you see this, correct it
        ...
        scroll.setOnTouchListener(this);
        pathScroll.setOnTouchListener(this);
        toListButton.setOnClickListener(this);
        toGridButton.setOnClickListener(this);
    ...
    public void setBackgroundColor(@ColorInt int color) {
        frame.setBackgroundColor(mainActivity.getResources().getColor(R.color.vectors_white));
    }
...
//        return gestureDetector.onTouchEvent(event);
    ...
    public void onClick(View view) {
        ...
        final MainFragment mainFragment = (MainFragment) mainActivity.getFragmentAtFrame();
        int pathLayout = dataUtils.getListOrGridForPath(mainFragment.getCurrentPath(), DataUtils.LIST);
        switch (view.getId()){
            case R.id.toGridButton:
                ...
                toGridButton.setVisibility(View.GONE);
                toListButton.setVisibility(View.VISIBLE);
                mainFragment.switchView();
                break;
            case R.id.toListButton:
                ...
                toGridButton.setVisibility(View.VISIBLE);
                toListButton.setVisibility(View.GONE);
                mainFragment.switchView();
                break;
        }
    }
