...
import com.augustro.filemanager.BuildConfig;
...
import com.augustro.filemanager.utils.ScreenUtils;
...
public class Drawer implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public Drawer(MainActivity mainActivity) {
        ...
        drawerHeaderParent.setBackgroundColor(ColorPreferenceHelper.getPrimary(mainActivity.getCurrentColorPreference(),1));
        ...
        drawerHeaderView.setBackgroundResource(R.drawable.filemagerapp_icon);
                ...
                synchronized (dataUtils.getBooks()) {
                    for (String[] file : dataUtils.getBooks()) {
                        addNewItem(menu, FOLDERS_GROUP, order++, file[0],
                                new MenuMetadata(file[1]), R.drawable.ic_folder_black_24dp,
                                R.drawable.ic_edit_24dp);
                    }
                }
            }
...
//
//        if (false /*mainActivity.getBoolean(PREFERENCE_SHOW_SIDEBAR_QUICKACCESSES)*/) {
...
//        }
    ...
    public void onDrawerClosed() {
        ...
        if (pendingPath != null) {
            ...
            Fragment fragment = mainActivity.getFragmentAtFrame();
            if (fragment instanceof MainFragment) {
                MainFragment mainFrag = (MainFragment) fragment;
