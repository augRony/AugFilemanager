package com.augustro.filemanager.ui.colors;
...
public class ColorPreferenceHelper {
    ...
    public static final @ColorRes int DEFAULT_PRIMARY_FIRST_TAB = R.color.primary_greenish,
            DEFAULT_PRIMARY_SECOND_TAB = R.color.primary_greenish,
            DEFAULT_ACCENT = R.color.primary_greenish,
            DEFAULT_ICON_SKIN = R.color.primary_greenish;
    ...
    public void saveColorPreferences(SharedPreferences prefs, UserColorPreferences userPrefs) {
        ...
        editor.putInt(PreferencesConstants.PREFERENCE_SKIN, userPrefs.primaryFirstTab).apply();
        editor.putInt(PreferencesConstants.PREFERENCE_SKIN_TWO, userPrefs.primarySecondTab).apply();
        editor.putInt(PreferencesConstants.PREFERENCE_ACCENT, userPrefs.accent).apply();
        editor.putInt(PreferencesConstants.PREFERENCE_ICON_SKIN, userPrefs.iconSkin).apply();
    ...
    private boolean isUsingOldColorsSystem(SharedPreferences prefs) {
        int tabOne = prefs.getInt(PreferencesConstants.PREFERENCE_SKIN, R.color.primary_greenish);
        int tabTwo = prefs.getInt(PreferencesConstants.PREFERENCE_SKIN_TWO, R.color.primary_greenish);
        int accent = prefs.getInt(PreferencesConstants.PREFERENCE_ACCENT, R.color.primary_greenish);
        int iconSkin = prefs.getInt(PreferencesConstants.PREFERENCE_ICON_SKIN, R.color.primary_greenish);
