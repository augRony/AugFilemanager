...
import com.augustro.filemanager.ui.colors.UserColorPreferences;
import com.augustro.filemanager.ui.views.CircularColorsView;
import com.augustro.filemanager.ui.views.preference.SelectedColorsPreference;
...
public class ColorPickerDialog extends SelectedColorsPreference {
    ...
    private static final ColorItemPair[] COLORS = new ColorItemPair[]{
            new ColorItemPair(R.string.defualt,
                    new int[]{R.color.primary_greenish, R.color.primary_greenish, R.color.primary_greenish, R.color.primary_greenish}),
            new ColorItemPair(R.string.indigoPink,
            ...
            new ColorItemPair(R.string.blue,
                    new int[]{R.color.primary_bluish, R.color.primary_bluish, R.color.primary_bluish, R.color.primary_bluish}),
    ...
    public void onBindDialogView(View view) {
        ...
        if(selectedIndex == NO_DATA) {//if instance was restored the value is already set
            boolean isUsingDefault = sharedPrefs.getInt(PreferencesConstants.PREFERENCE_COLOR_CONFIG, NO_DATA) == NO_DATA
                    && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_SKIN, R.color.primary_greenish) == R.color.primary_greenish
                    && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_SKIN_TWO, R.color.primary_greenish) == R.color.primary_greenish
                    && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_ACCENT, R.color.primary_greenish) == R.color.primary_greenish
                    && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_ICON_SKIN, R.color.primary_greenish) == R.color.primary_greenish;
    ...
    private static class SavedState extends BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR =
                new Creator<ColorPickerDialog.SavedState>() {
                    public ColorPickerDialog.SavedState createFromParcel(Parcel in) {
                        return new ColorPickerDialog.SavedState(in);
                    }
                    public ColorPickerDialog.SavedState[] newArray(int size) {
                        return new ColorPickerDialog.SavedState[size];
                    }
                };
    }
