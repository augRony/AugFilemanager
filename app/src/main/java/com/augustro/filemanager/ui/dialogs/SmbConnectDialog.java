...
import com.augustro.filemanager.utils.EditTextColorStateUtil;
import com.augustro.filemanager.utils.SimpleTextWatcher;
import com.augustro.filemanager.utils.SmbUtil;
...
public class SmbConnectDialog extends DialogFragment {
    ...
    public interface SmbConnectionListener {
         ...
         *             See {@link UtilsHandler#removeSmbPath(String, String)}
         */
