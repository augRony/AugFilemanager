...
import com.augustro.filemanager.asynchronous.asynctasks.ssh.SshAuthenticationTask;
...
public class SshConnectionPool
{
    ...
    public SSHClient getConnection(@NonNull String url)  {
        ...
        if(client == null) {
            ...
            if(!validate(client)) {
                //Log.(TAG, "Connection no longer usable. Reconnecting...");
                expire(client);
    ...
    /**
     * Kill any connection that is still in place. Used by {@link MainActivity}.
     *
