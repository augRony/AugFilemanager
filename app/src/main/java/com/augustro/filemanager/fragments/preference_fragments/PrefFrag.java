...
import com.augustro.filemanager.activities.AboutActivity;
...
import static com.augustro.filemanager.R.string.feedback;
import static com.augustro.filemanager.activities.PreferencesActivity.START_PREFERENCE;
...
//            PreferencesConstants.FRAGMENT_FOLDERS,
            ...
            PreferencesConstants.PREFERENCE_CATEGORY_SECURITY};
        ...
        switch (preference.getKey()) {
            ...
            case PreferencesConstants.FRAGMENT_FEEDBACK:
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                        "mailto", "ronnan1996@gmail.com", null));
                ...
                if (isIntentSafe)
                    ...
                    Toast.makeText(getActivity(), getResources().getString(R.string.send_email_to)
                            + "ronnan1996@gmail.com", Toast.LENGTH_LONG).show();
                return false;
...
//                return true;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PreferenceScreen settingsScreen = (PreferenceScreen) findPreference(PreferencesConstants.PREFERENCE_SETTINGS_SCREEN);
        PreferenceCategory security = (PreferenceCategory) findPreference(PreferencesConstants.PREFERENCE_CATEGORY_SECURITY);
        PreferenceCategory miscellaneous = (PreferenceCategory) findPreference(PreferencesConstants.PREFERENCE_CATEGORY_MISCELLANEOUS);
        PreferenceCategory sidebar = (PreferenceCategory) findPreference(PreferencesConstants.PREFERENCE_CATEGORY_SIDEBAR);
        PreferenceCategory interfce = (PreferenceCategory) findPreference(PreferencesConstants.PREFERENCE_CATEGORY_INTERFACE);
        PreferenceCategory advanced = (PreferenceCategory) findPreference(PreferencesConstants.PREFERENCE_CATEGORY_ADVANCED);
        PreferenceCategory general = (PreferenceCategory) findPreference(PreferencesConstants.PREFERENCE_CATEGORY_GENERAL);
        CheckBox goBack = (CheckBox) findPreference(PreferencesConstants.PREFERENCE_SHOW_GOBACK_BUTTON);
        CheckBox openAsNewTask = (CheckBox) findPreference(PreferencesConstants.PREFERENCE_TEXTEDITOR_NEWSTACK);
        CheckBox customPath = (CheckBox) findPreference(PreferencesConstants.PREFERENCE_CHANGEPATHS);
        CheckBox showHeaders = (CheckBox) findPreference(PreferencesConstants.PREFERENCE_SHOW_HEADERS);
        CheckBox intelliHide = (CheckBox) findPreference(PreferencesConstants.PREFERENCE_INTELLI_HIDE_TOOLBAR);

        settingsScreen.removePreference(security);
        settingsScreen.removePreference(sidebar);
        settingsScreen.removePreference(advanced);
        general.removePreference(goBack);
        interfce.removePreference(showHeaders);
        interfce.removePreference(intelliHide);
        miscellaneous.removePreference(customPath);
        miscellaneous.removePreference(openAsNewTask);
