...
import com.augustro.filemanager.adapters.AppsAdapter;
import com.augustro.filemanager.adapters.glide.AppsAdapterPreloadModel;
import com.augustro.filemanager.asynchronous.loaders.AppListLoader;
...
public class AppsListFragment extends ListFragment implements LoaderManager.LoaderCallbacks<AppListLoader.AppsDataPair> {
    ...
    @Override
    public void onPause() {
        mainActivity.getAppbar().getBottomBar().setVisibility(View.VISIBLE);
