...
public class PreferencesConstants {
    ...
    public static final String PREFERENCE_CATEGORY_MISCELLANEOUS = "category_miscellaneous";
    ...
    public static final String PREFERENCE_SETTINGS_SCREEN = "settings_preference";
    public static final String PREFERENCE_CATEGORY_SIDEBAR = "sidebar";
    public static final String PREFERENCE_CATEGORY_SECURITY = "security";
    public static final String PREFERENCE_CATEGORY_INTERFACE = "interface";
    public static final String PREFERENCE_CATEGORY_ADVANCED = "advanced";
    public static final String PREFERENCE_CATEGORY_GENERAL = "settings_general";
