...
package com.augustro.filemanager.asynchronous.asynctasks.ssh;
...
import com.augustro.filemanager.asynchronous.asynctasks.AsyncTaskResult;
...
import static com.augustro.filemanager.filesystem.ssh.SshConnectionPool.SSH_CONNECT_TIMEOUT;

/**
 * {@link AsyncTask} for authenticating with SSH server to verify if parameters are correct.
 *
 * Used by {@link SftpConnectDialog}.
 *
 * @see SSHClient
 * @see SSHClient#authPassword(String, String)
 * @see SSHClient#authPublickey(String, KeyProvider...)
 * @see SftpConnectDialog#authenticateAndSaveSetup(String, String, int, String, String, String, String, KeyPair, boolean)
 * @see SshConnectionPool#create(Uri)
 */
