...
public class LayoutElementParcelable implements Parcelable {
    ...
    public LayoutElementParcelable(String path,
                                   String permissions,
                                   String symlink,
                                   String size,
                                   long longSize,
                                   ...
                                   boolean useThumbs,
                                   OpenMode openMode) {
        this(new File(path).getName(),
                path, permissions, symlink, size, longSize, header,
                date, isDirectory, useThumbs, openMode);

    }


    public LayoutElementParcelable(String title,
                                   String path,
                                   String permissions,
                                   String symlink,
                                   String size,
