package com.augustro.filemanager.adapters;
...
import com.augustro.filemanager.activities.superclasses.PreferenceActivity;
...
import com.augustro.filemanager.adapters.glide.RecyclerPreloadModelProvider;
import com.augustro.filemanager.adapters.glide.RecyclerPreloadSizeProvider;
import com.augustro.filemanager.adapters.holders.EmptyViewHolder;
import com.augustro.filemanager.adapters.holders.ItemViewHolder;
import com.augustro.filemanager.adapters.holders.SpecialViewHolder;
import com.augustro.filemanager.fragments.MainFragment;
import com.augustro.filemanager.ui.ItemPopupMenu;
import com.augustro.filemanager.ui.colors.ColorUtils;
import com.augustro.filemanager.ui.icons.Icons;
import com.augustro.filemanager.ui.icons.MimeTypes;
import com.augustro.filemanager.ui.views.CircleGradientDrawable;
import com.augustro.filemanager.ui.views.RoundedImageView;
import com.augustro.filemanager.utils.AnimUtils;
import com.augustro.filemanager.utils.GlideConstants;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public RecyclerAdapter(PreferenceActivity preferenceActivity,
                           MainFragment m,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case TYPE_HEADER_FILES: {
                ...
                if (mainFrag.dsort == 2) {
                    view = mInflater.inflate(R.layout.hide_header, parent, false);
                } else {
                    if (mainFrag.IS_LIST) {
        ...
        if (vholder instanceof ItemViewHolder) {
            ...
            if (mainFrag.IS_LIST) {
                ...
                if (isBackButton) {
                    ...
                    holder.txtDesc.setText(FileUtils.getNumberOfFilesInDirectoryAsString(mainFrag.getContext(),rowItem.desc));
                } else if (getBoolean(PREFERENCE_SHOW_FILE_SIZE)) {
                    if(rowItem.size!=null && !rowItem.size.isEmpty()) {
                        if (FileUtils.getNumberOfFilesInDirectory(rowItem.desc) >= 0) {
                            holder.txtDesc.setText(FileUtils.getNumberOfFilesInDirectoryAsString(mainFrag.getContext(),rowItem.desc) + " | " + rowItem.size);
                        } else {
                ...
                if (isBackButton) {
                    holder.date.setText(rowItem.size);
                    holder.txtDesc.setText(FileUtils.getNumberOfFilesInDirectoryAsString(mainFrag.getContext(),rowItem.desc));
                }else if (getBoolean(PREFERENCE_SHOW_FILE_SIZE) && rowItem.isDirectory) {
                    holder.txtDesc.setText(FileUtils.getNumberOfFilesInDirectoryAsString(mainFrag.getContext(),rowItem.desc));
                }
                if (getBoolean(PREFERENCE_SHOW_PERMISSIONS))
                    holder.perm.setText(rowItem.permissions);
